...
#     path('posts_like/<int:id>', like_unlike_post, name='like-post-view'),
    path('posts_like/<int:post_pk>/<int:user_pk>/like/', PostLikeView.as_view(), name='post_like'),
    path('posts_dislike/<int:post_pk>/<int:user_pk>/dislike/', PostDislikeView.as_view(), name='post_dislike'),
